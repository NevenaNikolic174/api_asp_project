...
namespace MyProject.Api.Handlers.RestaurantHandler
{
    public class GetAllRestaurantsHandler
    {
        ...
        public GetAllRestaurantsHandler(MyDBContext context, IMapper mapper)
        {
            _dbCon = context;
            _mapper = mapper;
        }
        ...
        {
            var query = _dbCon.Restaurants.AsQueryable();
            ...
            return new OkObjectResult(new PageSearchResponse<RestaurantDTO>
            {
