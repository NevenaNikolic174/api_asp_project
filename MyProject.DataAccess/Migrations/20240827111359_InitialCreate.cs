        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductCode = table.Column<int>(type: "int", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseCaseUserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UseCaseUsers", x => new { x.UserId, x.UseCaseUserId });
                    table.ForeignKey(
                        name: "FK_UseCaseUsers_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRestaurants", x => new { x.ProductId, x.RestaurantId });
                    table.ForeignKey(
                        name: "FK_ProductRestaurants_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductRestaurants_Restaurants_RestaurantId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, false, false, null, "User" },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, false, false, null, "Admin" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductRestaurants_RestaurantId",
                table: "ProductRestaurants",
                column: "RestaurantId");
